...
router.delete('/Introduction/delete', async(req,res)=>{
  ...
  router.get('/teaminsert', (req,res) =>{
    res.render('teaminsert', {value,user});
 });

router.route('/Teammates/teaminsert')
.get(async(req,res)=>{
 value= req.query.value;
 console.log(value +"추가 get");
 res.end();
})
.post(async(req,res)=>{
  var {nme,work,age,phone,email} = req.body;
    
    console.log(value+"추가 psot");
    try{
